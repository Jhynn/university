...
void Alumn::setScore1(float score) {
    score_1 = score;
}

float Alumn::getScore1() {
    return score_1;
}

void Alumn::setScore2(float score) {
    score_2 = score;
}

float Alumn::getScore2() {
    return score_2;
}

void Alumn::setScore3(float score) {
    score_3 = score;
}

float Alumn::getScore3() {
    return score_3;
}
